...
from AM.Helper.requirements import get_video_stream
...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    image4.text((10, 10), "ECO MUSIC", fill="white", font = font1, align ="left") 
...
@AM.on_message(filters.command(["vplay"], prefixes=["/", "."]))
